...
wysiwygString+=textareaID+",";
  ...
  var toolbar;
  toolbar =  '<table cellpadding="0"  cellspacing="0" border="0" class="toolbar1"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>'; // MODIFIED BY IRWAN SETIAWAN, ENGINEERING SERVICES - PT DI BANDUNG 
  ...
  var toolbar2;
  toolbar2 = '<table cellpadding="0" cellspacing="0" border="0" class="toolbar2"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>'; // MODIFIED BY IRWAN SETIAWAN, ENGINEERING SERVICES - PT DI BANDUNG
  ...
  toolbar2 += '<td>&nbsp;</td></tr></table>';  
	...
	var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:' + wysiwygWidth + 'px; height:' + wysiwygHeight + 'px;border: 1px solid #999999;background:#FFFFFF"><tr><td valign="top">\n'
...
/* ---------------------------------------------------------------------- *\
  ...
  Description : Puts <br> in on carriage return rather than <p>
  Usage       : doOnKeyPress(n)
  Arguments   : n   - The editor identifier (the textarea's ID)
\* ---------------------------------------------------------------------- */

function doOnKeyPress(n) {
  var oEditor = eval("wysiwyg"+n)
...
function rezetTextArea() {
  var wa=wysiwygString.split(",");
  for (cw=0;cw<wa.length-1;cw++) {
    document.getElementById("wysiwyg" + wa[cw]).contentWindow.document.body.innerHTML=wysiwygBuffer[cw];
  }
}
function ibrowserpopup(e) {
  var w = screen.width - 375;
  var h = screen.height - 300;
  var winl = (screen.width - w) / 2;
  var wint = (screen.height - h) / 2;
  winprops = 'height='+h+',width='+w+',top='+wint+',left='+winl+',scrollbars='+scroll+',resizable';
  window.open("ibrowser/ibrowser.php?eopener="+e, "ibrowser", winprops);
}
function popimg(e) {
  var elm=document.getElementById(e);
  var w = screen.width - 450;
  var h = screen.height - 300;
  var winl = (screen.width - w) / 2;
  var wint = (screen.height - h) / 2;
  winprops = 'height='+h+',width='+w+',top='+wint+',left='+winl+',scrollbars=yes,resizable';
  window.open(elm.value, "vimage", winprops);
}
function iswysiwyg(n) {
  var wa=wysiwygString.split(",");
  for (cw=0;cw<wa.length-1;cw++) {
    if (wa[cw]==n) return true;
  }
  return false;
}
