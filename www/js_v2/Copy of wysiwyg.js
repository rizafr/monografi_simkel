...
wysiwygString+=textareaID+",";
  ...
  var toolbar;
  toolbar =  '<table cellpadding="2"  cellspacing="0" border="0" class="toolbar1" style="width:' + toolbarWidth + 'px;"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
...
function ibrowserpopup(e) {
  ...
  window.open("/adminContent/gen/jscripts/openwysiwyg/ibrowser/ibrowser.php?eopener="+e, "ibrowser", winprops);
}
function popimg(e) {
