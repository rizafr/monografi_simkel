...
class format_page {
	...
	public function showPage($totalData, $numToDisplay, $currentPage, $divId, $modul, $param1, $param2, $param3, $param4)
	{
		...
		{
			//dirubah 29022010$keluaran = $keluaran." 	 	<a title=\"Klik untuk langsung ke halaman ... \" onclick=\"jumpto('$divId', '$modul','$totalPages','$fungsi', '$param1', '$param2', '$param3', '$param4'); return false;\" href=\"#pageCursor\">Halaman $currentPage dari $totalPages</a> &bull;";			
			$keluaran = $keluaran." 	 	<a title=\"Klik untuk langsung ke halaman ... \" onclick=\"jumpto('$divId', '$totalPages','$fungsi', '$param1', '$param2', '$param3', '$param4'); return false;\" href=\"#pageCursor\">Halaman $currentPage dari $totalPages</a> &bull;";			
		}
		...
		{
			$a = $currentPage -1;
			$keluaran =  $keluaran . "&nbsp;<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage('$divId', '$modul','$a','$param1','$param2','$param3','$param4');\">&laquo; sebelumnya</a>";
		}
		...
		{
			$a = $currentPage +1;
			$keluaran =  $keluaran . "<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage('$divId', '$modul','$a','$param1','$param2','$param3','$param4');\">berikutnya &raquo;</a>";
		}
		else 
		{
	...
	public function showPagexx($totalData, $numToDisplay, $currentPage, $divId, $modul, $param1, $param2, $param3, $param4)
	{
...
public function showPage8($totalData, $numToDisplay, $currentPage, $divId, $modul, $param1, $param2, $param3, $param4, $param5, $param6, $param7, $param8)
	{
		...
		{
			$keluaran = $keluaran." 	 	<a title=\"Klik untuk langsung ke halaman ... \" onclick=\"jumpto7('$divId', '$modul','$totalPages','$fungsi', '$param1', '$param2', '$param3', '$param4', '$param5', '$param6', '$param7', '$param8'); return false;\" href=\"#pageCursor\">Halaman $currentPage dari $totalPages</a> &bull;";			
		}
		...
		{
			$a = $currentPage -1;
			$keluaran =  $keluaran . "&nbsp;<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage7( '$modul','$divId','$a','$param1','$param2','$param3','$param4', '$param5', '$param6', '$param7', '$param8');\">&laquo; sebelumnya</a>";
		}
		...
		if($totalPages <= $indexEndPage)
		{
			for($a=$indexStartPage; $a <= $totalPages; $a ++)
			{
				...
				{
					$keluaran =  $keluaran . "<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage7('$modul','$divId', '$a','$param1','$param2','$param3','$param4', '$param5', '$param6', '$param7', '$param8');\">$a</a>";
				}
			}
		}
		else
		...
		{
			$a = $currentPage +1;
			$keluaran =  $keluaran . "<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage7('$modul','$divId', '$a','$param1','$param2','$param3','$param4', '$param5', '$param6', '$param7', '$param8');\">berikutnya &raquo;</a>";
		}
		else 
		{
...
public function showPage10($totalData, $numToDisplay, $currentPage, $divId, $modul, $param1, $param2, $param3, $param4, $param5, $param6, $param7, $param8, $param9, $param10)
	{
		...
		{
			$keluaran = $keluaran." 	 	<a title=\"Klik untuk langsung ke halaman ... \" onclick=\"jumpto10('$divId', '$modul','$totalPages','$fungsi', '$param1', '$param2', '$param3', '$param4', '$param5', '$param6', '$param7', '$param8', '$param9', '$param10'); return false;\" href=\"#pageCursor\">Halaman $currentPage dari $totalPages</a> &bull;";			
		}
		...
		{
			$a = $currentPage -1;
			$keluaran =  $keluaran . "&nbsp;<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage10( '$modul','$divId','$a','$param1','$param2','$param3','$param4', '$param5', '$param6', '$param7', '$param8', '$param9', '$param10');\">&laquo; berikutnya</a>";
		}
		...
		if($totalPages <= $indexEndPage)
		{
			for($a=$indexStartPage; $a <= $totalPages; $a ++)
			{
				...
				{
					$keluaran =  $keluaran . "<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage10('$modul','$divId', '$a','$param1','$param2','$param3','$param4', '$param5', '$param6', '$param7', '$param8', '$param9', '$param10');\">$a</a>";
				}
			}
		}
		else
		...
		{
			$a = $currentPage +1;
			$keluaran =  $keluaran . "<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage10('$modul','$divId', '$a','$param1','$param2','$param3','$param4', '$param5', '$param6', '$param7', '$param8', '$param9', '$param10');\">sebelumnya &raquo;</a>";
		}
		else 
		{
