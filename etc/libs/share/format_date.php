...
class format_date {
  ...
  public function formTanggal($namaTgl,$valueTgl,$namaBln,$valueBln,$namaThn,$valueThn,$tabId=null) {
    $ctrl = new Zend_View();
 ...
 public function xformTanggal_oa($namaTgl,$valueTgl,$namaBln,$valueBln,$namaThn,$valueThn,$tabId=null) 
  ...
  /**
       ...
       */
  public function convertTglMachineToHuman($tglmachine) {///echo $tglmachine;
	if($tglmachine) {
   ...
   public function convertTglMachineToHumanSita($tglmachine) {
	if($tglmachine) {
	$bln = substr($tglmachine, 0, 3);
	//echo "<br>".$thn;
	$tgl = substr($tglmachine, 4, 5);
	//echo "<br>".$bln;
    $thn = substr($tglmachine, 7, 10);
	//echo "<br>".$tgl;
	return $tgl."-".$bln."-".$thn;
	}
	else {
 ...
 /* Candra */
  /**
	...
	public function formatTglLengkap2($tglmachine){
		//inputnya 05-02-2010
		$convDate = new format_date ();

		$tgl = substr($tglmachine, 0, 2);
		$bln = $convDate->getNamaBulan(substr($tglmachine, 4, 2));
		$thn = substr($tglmachine, 6, 4);
