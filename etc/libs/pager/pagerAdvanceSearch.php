<?
class halamanAdvCari{
    function halamanAdvCari() {
       //echo 'I am constructed';
    }
  public function navPagerAdvCari($total,$rowsPerPage,$pageNum,$awal,$akhir,$judul,$jnsProduk,$nmBumn,$group){
...
for($page = 1; $page <= $maxPage; $page++)
{
   ...
   else
   {
      ...
      $onklik = "getPageAdvSearch($page,$judul,$jnsProduk,$nmBumn,$group)";      	  	  
