...
//====================================
function InsertChart( $flash_file, $library_path, $php_source, $width, $height, $bg_color="666666", $transparent=false, $license=null ){


	$php_source=urlencode($php_source);
	$library_path=urlencode($library_path);

//echo "libpath ".$library_path." php_source ".$php_source." file ".$flash_file;
